...
//image[hoshizuki_txlink][トランザクションのリンク構造]
...
//image[hoshizuki_txid][TXID とリンク構造]
...
//image[hoshizuki_merkle][トランザクションとマークルツリー]
...
これは大問題ということで提案されたのが
@<href>{https://github.com/bitcoin/bips/blob/master/bip-0030.mediawiki, BIP-30}
...
そこでその問題を解決しようと提案されたのが
@<href>{https://github.com/bitcoin/bips/blob/master/bip-0034.mediawiki, BIP-34}
です。
...
衝突する可能性が指摘されました。
//image[hoshizuki_b34collision][BIP-34 導入以前との衝突可能性]
...
エクストラ Nonce が BIP-34 形式で解釈可能なものは複数あった、と。
@<href>{https://github.com/bitcoin/bitcoin/pull/12204, プルリク12204}
...
@<href>{https://github.com/bitcoin/bitcoin/commit/5b8b387752e8c493a8e87795ae6ddb78b45b1a5d, BIP-34 対応コミット}
